/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f490c1b280d1e5e0d26230284a7e2389)
// Runtime types generated with workerd@1.20260820.1 2026-06-10 
interface __BaseEnv_Env {
	UID_CONFIG: KVNamespace;
	CURRENCY_LABEL: "credits";
	CURRENCY_DECIMALS: "0";
	FAKEWALLET_CURRENCY: "EUR";
	FAKEWALLET_IBAN: "GB33BUKB20201555555555";
	FAKEWALLET_ACCOUNT_NAME: "FakeWallet";
	CARD_REPLAY: DurableObjectNamespace<import("./index").CardReplayStore>;
	routes?: ["https://boltcardpoc.psbt.me/*"];
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "CardReplayDO" | "CardReplayStore";
	}
