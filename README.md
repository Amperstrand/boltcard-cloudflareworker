...
When `payment_method: "cashu"`, card taps are proxied to a [lnforward](https://github.com/Amperstrand/lnforward) instance which settles payments via Cashu mints. No Lightning node required — the Cashu mint handles Lightning settlement.
