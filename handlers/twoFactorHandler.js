    ...
    <div class="min-h-screen p-4 md:p-8 font-sans antialiased flex flex-col items-center">
      <div class="max-w-lg w-full bg-gray-800 border border-gray-700 shadow-xl rounded-lg p-6 md:p-8">
        ...
        <div class="mb-8 text-center">
          ...
          <div class="mt-3 flex items-center justify-center gap-2">
            <div class="w-full bg-gray-700 rounded-full h-2 max-w-xs">
              <div class="bg-emerald-500 h-2 rounded-full transition-all duration-1000" id="totp-bar" style="width: ${(totp.secondsRemaining / 30) * 100}%"></div>
            </div>
            <span class="text-sm text-gray-400 font-mono w-8 text-right" id="totp-timer">${totp.secondsRemaining}s</span>
          </div>
        </div>
        ...
        <div class="mt-5 flex items-center justify-center gap-4 text-xs text-gray-500">
          <a href="/debug" class="hover:text-gray-300 transition-colors">Debug tools &rarr;</a>
          <a href="/identity" class="hover:text-cyan-300 transition-colors">Identity demo &rarr;</a>
        </div>
      ...
      <section class="rounded-3xl border border-gray-800 bg-gray-900/80 p-6 shadow-2xl shadow-black/30 md:p-8">
        <div class="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div class="flex flex-wrap items-center gap-3">
            ...
            <button id="scan-indicator" class="rounded-xl border border-red-500/30 bg-red-500/10 px-4 py-2 text-sm font-semibold text-red-200 transition hover:bg-red-500/20">NFC inactive &middot; click to start</button>
          </div>
        </div>
        ...
        <div class="mt-8 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div class="rounded-2xl border border-cyan-500/20 bg-gray-950/70 p-6">
            ...
            <div class="mt-6 rounded-2xl border border-gray-800 bg-gray-900/80 p-5">
              ...
              <div id="scan-status" class="mt-3 text-lg font-semibold text-cyan-300">Waiting to start NFC scan&hellip;</div>
          ...
          <div class="space-y-4">
            <div class="rounded-2xl border border-gray-800 bg-gray-950/70 p-5">
              ...
              <ul class="mt-3 space-y-3 text-sm leading-6 text-gray-300">
                <li>&bull; <span class="font-semibold text-white">TOTP</span> refreshes automatically every 30 seconds.</li>
                <li>&bull; <span class="font-semibold text-white">HOTP</span> changes when the card counter changes.</li>
                <li>&bull; The live page also exposes the same signed card proof that could later back stronger verifiable-credential flows.</li>
              </ul>
            </div>
            <div class="rounded-2xl border border-gray-800 bg-gray-950/70 p-5">
